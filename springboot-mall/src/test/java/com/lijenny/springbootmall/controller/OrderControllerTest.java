...
import static org.hamcrest.Matchers.*; //notNullValue()使用
...
class OrderControllerTest {
    ...
    @Transactional
    @Test
    public void createOrder_success1() throws Exception {
    ...
    @Transactional
    @Test
    public void createOrder_stockNotExist() throws Exception{
        CreateOrderRequest createOrderRequest=new CreateOrderRequest();
        List <BuyItem> buyItemList =new ArrayList <> ();
        BuyItem buyItem1=new BuyItem();
        buyItem1.setProductId(1);
